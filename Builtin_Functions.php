...
<div class="container">
    ...
    <table>
        ...
        <tr><td>Case</td><td>strtolower()</td><td><?= $lowercase ?></td></tr>
        <tr><td>Case</td><td>strtoupper()</td><td><?= $uppercase ?></td></tr>
        <tr><td>Case</td><td>ucwords()</td><td><?= $capitalize ?></td></tr>

        <!-- Counting Characters and Words -->
        <tr class="section"><td colspan="3">Counting Characters and Words</td></tr>
        <tr><td>Count</td><td>strlen()</td><td><?= $charCount ?></td></tr>
        <tr><td>Count</td><td>str_word_count()</td><td><?= $wordCount ?></td></tr>

        <!-- Removing and Replacing Characters -->
        <tr class="section"><td colspan="3">Removing and Replacing Characters</td></tr>
        <tr><td>Trim</td><td>ltrim()</td><td><?= $ltrimmed ?></td></tr>
        <tr><td>Trim</td><td>rtrim()</td><td><?= $rtrimmed ?></td></tr>
        <tr><td>Trim</td><td>trim()</td><td><?= $trimmed ?></td></tr>
        <tr><td>Replace</td><td>str_replace()</td><td><?= $strReplace ?></td></tr>
        <tr><td>Replace</td><td>str_ireplace()</td><td><?= $strIReplace ?></td></tr>
        <tr><td>Repeat</td><td>str_repeat()</td><td><?= $strRepeat ?></td></tr>
